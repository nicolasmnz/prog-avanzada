...
Para ver el estado de que archivos han cambiado, cuales cambios se han agregado a la lista de cambios, o los conflictos (contenido que se vera despues), se utiliza el comando \texttt{git status}, que indica el estado actual de los archivos y lista de cambios

\begin{lstlisting}[language=bash, style=terminal, caption={git status: Ver estado de los cambios}]
